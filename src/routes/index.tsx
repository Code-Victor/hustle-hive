            ...
            >
              ...
              <div className="bg-white rounded-lg p-8 shadow-md">
                ...
                <p className="text-gray-600 text-center">
                  ...
                  ability to address Rwanda’s labor market challenges
                  effectively.
                </p>
              </div>
              {/* Creativity Card */}
              <div className="bg-white rounded-lg p-8 shadow-md">
                ...
                <p className="text-gray-600 text-center">
                  ...
                  opportunities for job creation. Creativity helps us to adapt
                  to challenges and find impactful ways to empower communities.
                </p>
              </div>
              {/* Collaboration Card */}
              <div className="bg-white rounded-lg p-8 shadow-md">
                ...
                <p className="text-gray-600 text-center">
                  We believe in the power of working together. By fostering
                  strong partnerships with communities, stakeholders, and
                  organizations, we amplify our impact and create a shared
                  vision for sustainable job creation and economic growth in
                  Rwanda.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="space-y-6 ">
                ...
                <p className="text-gray-600 text-justify md:text-xl">
                  ...
                  focusing on maximizing agricultural produce. Through
                  innovative approaches to agriculture, we aim to create
                  sustainable employment opportunities for the Rwandan youth
          ...
          {activeTab === "mission" && (
            ...
            >
              <div className="space-y-6 ">
                ...
                <p className="text-gray-600 text-justify md:text-xl">
                  Our mission is to enhance job creation in Rwanda by
                  diversifying agricultural food systems. We aim to optimize
                  local production by leveraging our agricultural resources in
                  diverse ways. By cultivating a variety of crops and developing
                  value-added products, we will expand employment opportunities
